...
SaveDir = [pwd '\results\experiments\'];
...
print([SaveDir 'alltax_vs_te_gamma097'],'-depsc')
...
fid=fopen([SaveDir 'sensitivity_gamma097_table.tex'],'w');
...
print([SaveDir 'alltax_vs_te_gamma08'],'-depsc')
...
fid=fopen([SaveDir 'sensitivity_gamma08_table.tex'],'w');
fprintf(fid,'\n \\documentclass[12pt]{article}');
fprintf(fid,'\n \\begin{document}');
...
print([SaveDir 'alltax_vs_te_gamma05'],'-depsc')
